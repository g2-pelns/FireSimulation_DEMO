...
bool FireShaderClass::Init(ID3D11Device* device, HWND hwnd)
{
	bool result;

	//Initilize the vertex and pixel shaders
	result = InitShader(device, hwnd, L"../ConsoleApplication1/FireVS.hlsl", L"../ConsoleApplication1/FirePS.hlsl");
	if (!result)
	{
		return false;
	}
...
bool FireShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, DirectX::XMMATRIX& worldMatrix, DirectX::XMMATRIX& viewMatrix, DirectX::XMMATRIX& projectionMatrix,
	...
	DirectX::XMFLOAT3 scrollSpeeds, DirectX::XMFLOAT3 scales, DirectX::XMFLOAT2 distortion1, DirectX::XMFLOAT2 distortion2, DirectX::XMFLOAT2 distortion3, float distortionScale, float distortionBias)
{
	bool result;
...
bool FireShaderClass::InitShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename , WCHAR* psFilename)
{
	HRESULT result;
...
bool FireShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, DirectX::XMMATRIX& worldMatrix, DirectX::XMMATRIX& viewMatrix, DirectX::XMMATRIX& projectionMatrix,
	ID3D11ShaderResourceView* fireTexture, ID3D11ShaderResourceView* noiseTexture, ID3D11ShaderResourceView* alphaTexture, float frameTime, DirectX::XMFLOAT3 scrollSpeeds, DirectX::XMFLOAT3 scales,
